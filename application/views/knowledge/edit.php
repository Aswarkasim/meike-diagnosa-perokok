    ...
    <div class="box-body no-padding">
        ...
        ?>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <select name="kode_gejala" class="form-control">
                                ...
                                <option <?php if($row->kode_gejala==$knowledge->gejala){echo "selected";} ?> value="<?= $row->kode_gejala ?>"><?= $row->kode_gejala ?> - <?= $row->nama_gejala ?></option>
                                <?php  } ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="pertanyaan" value="<?= $knowledge->pertanyaan ?>">
                    </div>
                </div><br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="is_yes" value="<?= $knowledge->is_yes ?>">
                    </div>
                </div><br>
                <div class="row">
                    <div class="col-md-3"><strong>JAWABAN TIDAK <small class="text-danger">*</small><span class="pull-right">:</span></strong></div>
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="is_no"value="<?= $knowledge->is_no ?>">
                    </div>
                </div><br>
